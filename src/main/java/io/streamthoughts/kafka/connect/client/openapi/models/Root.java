...
public class Root {
    ...
    public Root commit(String commit) {
    ...
    public Root kafkaClusterId(String kafkaClusterId) {
    ...
    public boolean equals(Object o) {
        ...
        Root root = (Root) o;
        return Objects.equals(this.version, root.version)
                && Objects.equals(this.commit, root.commit)
                && Objects.equals(this.kafkaClusterId, root.kafkaClusterId);
    }
