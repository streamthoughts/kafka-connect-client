...
import io.streamthoughts.kafka.connect.client.openapi.auth.ApiKeyAuth;
import io.streamthoughts.kafka.connect.client.openapi.auth.Authentication;
import io.streamthoughts.kafka.connect.client.openapi.auth.HttpBasicAuth;
import java.io.File;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/${project.version}/java");
