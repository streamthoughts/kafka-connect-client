...
public class ConnectApi {
  ...
  public Version getConnectVersion() throws ApiException {
    ApiResponse<Version> localVarResp = getConnectVersionWithHttpInfo();
   ...
   * </table>
   */
  public okhttp3.Call getConnectVersionAsync(final ApiCallback<Version> _callback)
      throws ApiException {
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call getConnectorInfoValidateBeforeCall(String name, final ApiCallback _callback)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<ConnectorInfo> getConnectorInfoWithHttpInfo(String name) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getConnectorInfoAsync(String name, final ApiCallback<ConnectorInfo> _callback)
      throws ApiException {
  ...
  /**
   * gets current status of the connector, including whether it is running, failed or paused, which
  ...
  /**
   * (asynchronously) gets current status of the connector, including whether it is running, failed
   * or paused, which worker it is assigned to, error information if it has failed, and the state of
   * all its tasks.
   *
   * @param name The name of the connector (required)
   * @param _callback The callback to be executed when the API call finishes
  ...
  public okhttp3.Call getConnectorTaskStatusAsync(
      String name, Integer taskId, final ApiCallback<TaskState> _callback) throws ApiException {

    okhttp3.Call localVarCall = getConnectorTaskStatusValidateBeforeCall(name, taskId, _callback);
    Type localVarReturnType = new TypeToken<TaskState>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
   ...
   * </table>
   */
  public okhttp3.Call listConnectorPluginsAsync(final ApiCallback<List<ConnectorPlugin>> _callback)
      throws ApiException {
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call restartConnectorValidateBeforeCall(String name, final ApiCallback _callback)
      throws ApiException {
  ...
  /**
   * (asynchronously) resumes a paused connector or do nothing if the connector is not paused. This
   * call is asynchronous and the tasks will not transition to RUNNING state at the same time.
   *
   * @param name The name of the connector to resume (required)
   * @param _callback The callback to be executed when the API call finishes
   * @return The request call
  ...
  public okhttp3.Call updateOrCreateConnectorConfigAsync(
      String name, Map<String, String> requestBody, final ApiCallback<ConnectorInfo> _callback)
      throws ApiException {
